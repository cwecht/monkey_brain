...
class GenerateCpp(GenerateCommandExtension):
    ...
    def generate(
        ...
        package_share_path = \
            pathlib.Path(get_package_share_directory('rosidl_generator_monkey_brain'))
        ...
        with legacy_generator_arguments_file(
            ...
            return generate_monkey_brain_plugins(path_to_arguments_file)
